...
namespace JobInfoSortingApp.Controllers
{
    public class SkillsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SkillsId,SkillName,SkillType")] Skills skills)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SkillsId,SkillName,SkillType")] Skills skills)
        {
